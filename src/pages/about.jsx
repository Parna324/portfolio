        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-700 dark:text-slate-300 font-medium leading-relaxed max-w-xl">
              I'm Parna Ghosh, a Computer Science student at Lovely Professional
              University with a deep interest in building scalable,
              high-performance web applications. I love bridging the gap between
              design and technology, ensuring every project I touch feels
              polished, premium, and meaningful.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 py-4">
              <div className="space-y-1">
                ...
                <p className="text-xs font-bold uppercase tracking-tighter text-slate-500 dark:text-slate-400">
                  Core Projects
                </p>
              </div>
              <div className="space-y-1">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Link
                to="/resume"
                className="px-8 py-4 bg-white/10 hover:bg-white/20 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white font-bold rounded-2xl backdrop-blur-xl transition-all hover:-translate-y-1"
              >
                My Resume
              </Link>
            </div>
